      ...
      <div class="bg-white/95 border border-slate-200/80 p-8 sm:p-10 rounded-2xl shadow-xl shadow-slate-200/50 space-y-8">
        ...
        <div class="text-center space-y-3.5">
          ...
          <div class="space-y-1">
            ...
            <p class="text-xs text-slate-400 font-bold uppercase tracking-wider">Recover your Laraforge<span
                class="text-brand-600">X</span> dashboard access</p>
          </div>
        </div>
        ...
        <form id="forgot-form" class="space-y-5">
          ...
          <div class="text-center pt-2">
            <a href="/admin/login" class="text-xs font-bold text-slate-400 hover:text-slate-600 transition"><i
                class="fa-solid fa-arrow-left mr-1"></i> Back to Login</a>
          </div>
        </form>
