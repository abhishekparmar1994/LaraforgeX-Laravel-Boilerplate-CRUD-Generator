...
@section('content')
  <div class="space-y-6 font-sans w-full relative">
    ...
    <div id="column-bulk-bar"
      class="hidden sticky top-4 z-30 bg-white border border-slate-200 rounded-2xl p-3 sm:p-4 shadow-xl text-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 transition-all">
